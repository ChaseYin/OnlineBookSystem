...
mongoose.connect('mongodb+srv://Chase:yinxiaofeng0206@sit313.e6wwd.mongodb.net/90016?retryWrites=true&w=majority',function(err){
    //mongoose.connect('mongodb://localhost:27017/90016ABC',function(err){
   if(err){
